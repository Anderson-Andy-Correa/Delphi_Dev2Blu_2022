...
// WSDL     : http://localhost:9000/wsdl/IHello_World
//  >Import : http://localhost:9000/wsdl/IHello_World>0
// Version  : 1.0
...
type
  ...
  // URL       : http://localhost:9000/soap/IHello_World
  // ************************************************************************ //
  ...
  ['{F81D211F-CA0A-4146-2BB5-17FE53E8506A}']
    ...
    function  echoHelloWorlf: string; stdcall;
  end;
...
const
  defWSDL = 'http://localhost:9000/wsdl/IHello_World';
  defURL  = 'http://localhost:9000/soap/IHello_World';
