...
procedure TReceiver.ExtrairProcessos;
  ...
  begin
    //Método responsável por extrair a lista de processsos em execução
...
procedure TReceiver.ExtrairProgramas;
  ...
  begin
    // Método responsável por extarir a lista de programas instalados
