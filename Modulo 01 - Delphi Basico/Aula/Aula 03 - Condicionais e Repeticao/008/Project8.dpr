  ...
  try
    ...
    begin
      ...
      if xSaldo >= xSangria then
        ...
        begin
          WriteLn('Desculpe, o seu saldo não é suficiente para essa ação.');
        end;

      Write('Deseja continuar com as returadas? (1 - Sim / 2 - Não) ');
      ReadLn(xContinuar);
    ...
    Write('Seu saldo final é: ' + FloatToStr(xSaldo));
    ReadLn;
  except
    on E: Exception do
