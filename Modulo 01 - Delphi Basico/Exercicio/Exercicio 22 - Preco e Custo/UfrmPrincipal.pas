      ...
      begin
        ...
        if xVezes > 0 then
          for I := 1 to xVezes do
            begin
              repeat
               xCusto := StrToFloatDef(inputbox('Informar', Format('Informe o valor de custo do %dº produto: ',[(I)]), '0'), 0);
              until xCusto > 0;

              repeat
                xVenda := StrToFloatDef(inputbox('Informar', Format('Informe o valor de venda do %dº produto: ',[(I)]), '0'), 0);
              until xVenda > 0;
