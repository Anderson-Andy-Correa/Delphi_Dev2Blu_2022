...
procedure CadastrarFuncionario;
  ...
  begin
    ...
    Repeat
      xFuncionario.Nome := InputBox('Adicionando um funcionário ',Format('Qual o Nome do %d Funcionário? ', [xVezes]),'<Desconhecido>');
      while not TryStrToCurr(InputBox('Adicionando um funcionário ',Format('Qual o Salário do %d Funcionário? ', [xVezes]), '0'), xFuncionario.Salario) do
